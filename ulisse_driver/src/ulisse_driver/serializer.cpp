...
{
    buffer_.resize(offset_ + sizeof(char));
    memcpy(&buffer_[offset_], &value, sizeof(char));
    offset_ += sizeof(char);
    return offset_;
}
...
{
    buffer_.resize(offset_ + sizeof(int8_t));
    memcpy(&buffer_[offset_], &value, sizeof(int8_t));
...
{
    buffer_.resize(offset_ + sizeof(int16_t));
    memcpy(&buffer_[offset_], &value, sizeof(int16_t));
...
{
    buffer_.resize(offset_ + sizeof(int32_t));
    memcpy(&buffer_[offset_], &value, sizeof(int32_t));
...
{
    buffer_.resize(offset_ + sizeof(int64_t));
...
{
    buffer_.resize(offset_ + sizeof(uint8_t));
    memcpy(&buffer_[offset_], &value, sizeof(uint8_t));
...
{
    buffer_.resize(offset_ + sizeof(uint16_t));
    memcpy(&buffer_[offset_], &value, sizeof(uint16_t));
...
{
    buffer_.resize(offset_ + sizeof(uint32_t));
...
{
    buffer_.resize(offset_ + sizeof(uint64_t));
...
{
    buffer_.resize(offset_ + sizeof(float32_t));
    memcpy(&buffer_[offset_], &value, sizeof(float32_t));
...
{
    buffer_.resize(offset_ + sizeof(float64_t));
    memcpy(&buffer_[offset_], &value, sizeof(float64_t));
...
uint16_t Serializer::PacketAdd_charArray(char* value, uint16_t size)
{
    ...
    memcpy(&buffer_[offset_], value, size);
    offset_ += size;
    return offset_;
}
...
{
    buffer_.resize(offset_ + size * sizeof(uint16_t));
    memcpy(&buffer_[offset_], value, size * sizeof(uint16_t));
