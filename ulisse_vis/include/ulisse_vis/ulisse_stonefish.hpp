...
#include "ulisse_msgs/msg/ned_pose.hpp"
//#include "ulisse_msgs/msg/simulated_system.hpp"
...
class StoneFishVisualizer : public rclcpp::Node {
    ...
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr ulissePosePub_;
    ...
    nav_msgs::msg::Odometry ulissePose_;
    ...
    Eigen::RotationMatrix worldF_ASV_F_;
    rml::EulerRPY bodyF_ASV_;
...
public:
    StoneFishVisualizer(const std::string file_name);
