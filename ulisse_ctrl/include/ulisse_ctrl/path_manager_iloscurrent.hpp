#ifndef PATHMANAGERILOSCURRENT_H
#define PATHMANAGERILOSCURRENT_H
...
class PathManagerILOSCurrent {

public:
    /*
     * Constructor
    */
    PathManagerILOSCurrent();

    /*
     * Default Destructor
    */
    virtual ~PathManagerILOSCurrent();
    ...
    */
     ...
     * @return
     */
    bool ComputeGoalPosition(const ctb::LatLong& currentP, ctb::LatLong& goalP,double& delta, ctb::LatLong &closestPos, bool& pathmode);
    ...
    bool ComputeError(const ctb::LatLong &currentPos,const ctb::LatLong &currentRealPos,const ctb::LatLong &goalPos,
