...
PathManagerCurrent::PathManagerCurrent()
    :  centroid_ { 0.0, 0.0 }
    , startP_ { 0.0, 0.0 }
    , endP_ { 0.0, 0.0 }
{
...
bool PathManagerCurrent::Initialization(const ulisse_msgs::msg::PathData& path)
{
...
bool PathManagerCurrent::ComputeGoalPosition(const ctb::LatLong &currentPos, ctb::LatLong &goalPos,
...
Eigen::Vector3d PathManagerCurrent::ComputeDirectionVector(const Eigen::Vector2d &applied_velocity){
...
bool PathManagerCurrent::ComputeCrossTrackErrors(const ctb::LatLong &currentPos,const ctb::LatLong &currentRealPos,const ctb::LatLong &goalPos,
...
bool PathManagerCurrent::ComputeAppliedVelocity(const double &goal_heading, const double &goal_surge,
...
void PathManagerCurrent::RestartPath()
{
    double altitude;
