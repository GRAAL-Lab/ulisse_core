...
const std::string task_angular_position_rov_follow = "/ulisse/task/ASV_Angular_Position_Rov_Follow";
const std::string task_angular_position_obstacle = "/ulisse/task/ASV_Angular_Position_Obstacle";
...
const std::string task_cartesian_distance_rov_follow = "/ulisse/task/ASV_Cartesian_Distance_Rov_Follow";
const std::string task_cartesian_distance_obstacle = "/ulisse/task/ASV_Cartesian_Distance_Obstacle"; // Obstacle
...
const std::string task_linear_velocity_obstacle = "/ulisse/task/ASV_Linear_Velocity_Obstacle"; // ASV-ROV
