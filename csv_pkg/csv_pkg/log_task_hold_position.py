...
def main(args=None):
    ...
    subscription = g_node.create_subscription(TaskStatus, 'ulisse/log/task/asv_hold_position', chatter_callback)
    subscription  # prevent unused variable warning

    srv = g_node.create_service(Empty, 'ulisse/stop/task/asv_hold_position', stop_callback)
    ...
    export_csv = df.to_csv (directory + '/log_task_asv_hold_position.csv', index = None, header=True)
