...
def main(args=None):
    ...
    g_node = rclpy.create_node('logger_asv_angular_velocity')

    subscription = g_node.create_subscription(TaskStatus, 'ulisse/log/task/asv_control_velocity_angular', chatter_callback)
    subscription  # prevent unused variable warning

    srv = g_node.create_service(Empty, 'ulisse/stop/task/asv_angular_velocity', stop_callback)
    ...
    export_csv = df.to_csv (directory + '/log_task_asv_angular_velocity.csv', index = None, header=True)
