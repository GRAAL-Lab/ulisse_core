    ...
    while (reader.has_next()) {
        ...
        if (bag_message->topic_name == ulisse_msgs::topicnames::sensor_gps_data) {
        	...
        	obstacleFile_ << std::fixed << std::setprecision(6)
                           ...
                           << Obstacle_.bb_safe.x_bow        << ", "
                           << Obstacle_.bb_safe.x_stern      << ", "
                           << Obstacle_.bb_safe.y_starboard  << ", "
                           << Obstacle_.bb_safe.y_port       << ", "
                           << Obstacle_.bb_max.x_bow        << ", "
                           << Obstacle_.bb_max.x_stern      << ", "
                           << Obstacle_.bb_max.y_starboard  << ", "
                           << Obstacle_.bb_max.y_port       << ", "
