...
int main(int argc, char* argv[])
{
    ...
    std::string filename = home + "/logs/" + "bag_" + data.str() + ".csv";
    ...
    myfile << "t_start_file, t_filter, x, y, z, r, p, y, u, v, h"
    << ", rRate, pRate, yRate, cx, cy, bx, by, bz"
    << ", t_real, x_real, y_real, z_real, r_real, p_real, y_real, u_real, v_real, h_real"
    << ", rRate_real, pRate_real, yRate_real, cx, cy, bx, by, bz"
    << ", t_motor, hp, hs, t_desired_vel, desired_surge, desired_yaw_rate"
    << ", t_gps, lat, long, alt, speed, cog, t_compass, r, p, y "
